...
class Transformer(nn.Module):
    ...
    def forward(self, mask_inputs, feat_dis_org_embed, feat_dis_scale_1_embed, feat_dis_scale_2_embed):
        ...
        enc_outputs, enc_self_attn_probs = self.encoder(mask_inputs, feat_dis_org_embed, feat_dis_scale_1_embed,
                                                        feat_dis_scale_2_embed)
...
class Encoder(nn.Module):
    ...
    def forward(self, mask_inputs, feat_dis_org_embed, feat_dis_scale_1_embed, feat_dis_scale_2_embed):
        ...
        # learnable scale embedding
        scale_org_embed = repeat(self.scale_org_embedding, '() c () () -> b c h w', b=self.config.batch_size, h=24,
                                 w=32)

...
from Reinforce_your_layout.Creatilayout.src.models.attention_sd3_SiamLayout_lora import SiamLayoutLoRAJointTransformerBlock
...
class SiamLayoutSD3Transformer2DModel(ModelMixin, ConfigMixin, PeftAdapterMixin, FromOriginalModelMixin):
    ...
    def __init__(
        ...
        self.transformer_blocks = nn.ModuleList(
            [
                SiamLayoutLoRAJointTransformerBlock(
                    dim=self.inner_dim,
